...
def get_parser():
    ...
    parser.add_argument('--root', metavar='DIR', default='/devdata/home/pishichan/code/asr/data/mandarin/supervised/speak/dataTang/wav', help='root directory containing flac files to index')
...
=======
    search_path = os.path.join(dir_path, '*.' + args.ext)
>>>>>>> c189b9efd0820dd0f0421196cc34bf51c46748e1
