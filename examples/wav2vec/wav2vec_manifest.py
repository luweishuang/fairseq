...
def get_parser():
    ...
    parser.add_argument('--root', metavar='DIR', default='/devdata/home/pishichan/code/asr/data/mandarin/supervised', help='root directory containing flac files to index')
...
def main(args):
    ...
    search_path = os.path.join(dir_path, '*/dataTang/*/*.' + args.ext)
